...
function Hero() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:items-center">
    <div className="mx-auto max-w-xl text-center">
      ...
      AI Course Generator 
        <strong className="font-extrabold text-primary sm:block"> Programing.Community </strong>
      </h1>

      <p className="mt-4 sm:text-xl/relaxed">
      Join all sessions to enhance your knowledge and learn different skills.!
      </p>
