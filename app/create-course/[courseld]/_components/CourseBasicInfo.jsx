  ...
  return (
    <div className='p-10 border rounded-xl shadow-sm mt-5'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
        <div>
        <h2 className='font-bold text-3xl'>{course?.courseOutput?.course?.name || "Updating the course, please wait..."} <EditCourseBasicInfo course={course} refreshData={()=>refreshData(true)} /></h2>
